...
public class LocalAccountRegister extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(LocalAccountRegister.this, "Successfully created account", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(LocalAccountRegister.this, "Something went wrong, try again later", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_account_register);
